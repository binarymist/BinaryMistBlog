...
links = [{name = "Workshop", url = "https://xi.hope.net/workshops.html#-holistic-info-sec-for-web-developers-"}, {name = "Source Book Series", url = "publication/holistic-infosec-for-web-developers"}]
