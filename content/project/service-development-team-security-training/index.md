...
[{{< figure src="project/AverageCostOfFixingDefects.png" caption="Average Cost of Fixing Defects" alt="Average Cost of Fixing Defects" >}}](https://f0.holisticinfosecforwebdevelopers.com/chap06.html#leanpub-auto-cheapest-place-to-deal-with-defects)
   ...
   <div class="col-sm-10" style="padding-top: 10px">
      ...
      <div class="row" style="padding-top: 10px">
         ...
         <div class="col-xs-12 col-sm-9">
            ...
            <a class="btn btn-outline-primary" href="/tag/workshop"><i class="fas fa-tools"></i> Kim's other Workshops</a>
         </div>
      </div>
   </div>
</div>
...
Kim will walk us through the SSM threat modelling process with theory and hands on exercises in areas such as Physical, People, VPS, Network, Cloud and Web Applications. Including sub topics such as Docker, [Serverless](https://f1.holisticinfosecforwebdevelopers.com/chap05.html#cloud-countermeasures-serverless), [PowerShell](/event/isig-2017-workshop-windows-exploitation-and-persistence-with-ps/) and many others.
