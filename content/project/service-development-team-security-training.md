...
tags = ["services", "development-team-security-service", "productised-services", "workshops"]
   ...
   <div class="col-sm-10" style="padding-top: 10px">
      ...
      <div class="row" style="padding-top: 10px">
         ...
         <div class="col-xs-12 col-sm-9">
            ...
            <a class="btn btn-primary btn-outline" href="http://localhost:1313/BinaryMistBlog/publication/holistic-infosec-for-web-developers/">Source Book Series</a>
            <a class="btn btn-primary btn-outline" href="../../tags/workshops">Kim's other Workshops</a>
         </div>
      </div>
   </div>
   <div class="col-sm-1"></div>
